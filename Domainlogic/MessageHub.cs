...
namespace Domainlogic
{
    public class MessageHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            await Clients.All.SendAsync("SendAction", MessageTypeEnum.Joined, ConnectedIds.Count, Names.Values.ToList());
        }
        ...
        public override async Task OnDisconnectedAsync(Exception ex)
        {
            ...
            await Clients.All.SendAsync("SendAction", MessageTypeEnum.Left, ConnectedIds.Count, Names.Values.ToList());
        }
